...
# 
# I discretize the data and predit $X_t+dlt$ from X_t with $$X_t+dlt = dlt * (A +I) Xt$$ with 10 step, dlt = 10 * 1/fs

# In[1]:


RUN_PYTHON_SCRIPT = False
MODEL_NAME = "Lay2_dis_10step_latent_intervalbds_model"
SAVED_MODEL = None
MODEL_CLASS = "my_main_model_dis_latent.py"
...
from models.losses import my_nllloss
